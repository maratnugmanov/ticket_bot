...
class String(enum.StrEnum):
    ...
    DEVICE_ACTION_SET_TO_INSTALL = "Выбрана установка устройства"
    DEVICE_ACTION_SET_TO_RETURN = "Выбран возврат устройства"
    INSTALL_OR_RETURN_WAS_EDITED = "Действие с устройством было изменено"
    INSTALL_OR_RETURN_REMAINED_THE_SAME = "Действие с устройством осталось прежним"
