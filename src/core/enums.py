...
class String(enum.StrEnum):
    ...
    # Menus Strings
    AVAILABLE_TICKET_ACTIONS = "Возможные действия: изменение номера текущей заявки/договора, изменение/добавление/удаление устройств, закрытие/открытие заявки и выход без сохранения"
    AVAILABLE_DEVICE_ACTIONS = "Возможные действия: изменение серийного номера и типа устройства, смена производимого над ним действия, возврат в предыдущее меню или удаление устройства из данной заявки"
    AVAILABLE_TICKETS_ACTIONS = "Возможные действия: добавление новой заявки, изменение/удаление старых заявок и возврат в главное меню"
    AVAILABLE_WRITEOFF_DEVICE_ACTIONS = "Возможные действия: изменение серийного номера и типа бракованного устройства, возврат в предыдущее меню или удаление устройства из брака"
    AVAILABLE_WRITEOFF_DEVICES_ACTIONS = "Возможные действия: добавление/изменение/удаление брака или возврат в предыдущее меню"
    # Ticket Strings
    ...
    RETURN_CHANGED_TO_INSTALL = "Возврат изменен на установку"
