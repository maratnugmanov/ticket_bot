...
class CallbackData(enum.StrEnum):
    ...
    EXISTING_TICKETS_BTN = enum.auto()
...
class String(enum.StrEnum):
    ...
    PICK_EXISTING_TICKETS_ACTION = "Возможные действия: добавление новых заявок, изменение/удаление старых заявок или возврат в предыдущее меню"
