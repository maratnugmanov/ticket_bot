...
class String(enum.StrEnum):
    ...
    # Menus Strings
    AVAILABLE_TICKET_ACTIONS = "Возможные действия: изменение номера текущей заявки/договора, изменение/добавление/удаление устройств, закрытие/возврат в работу/удаление заявки"
    AVAILABLE_DEVICE_ACTIONS = "Возможные действия: изменение серийного номера и типа устройства, смена производимого над ним действия или удаление устройства из заявки"
    AVAILABLE_TICKETS_ACTIONS = "Возможные действия: добавление новой заявки и просмотр и изменение имеющихся заявок"
    AVAILABLE_WRITEOFF_DEVICE_ACTIONS = "Возможные действия: изменение серийного номера и типа бракованного устройства или удаление устройства из брака"
    AVAILABLE_WRITEOFF_DEVICES_ACTIONS = (
        "Возможные действия: добавление/изменение или удаление бракованного устройства"
    )
    # Ticket Strings
    ...
    TICKET_NUMBER_REMAINED_THE_SAME = "Номер заявки остался прежним"
    ...
    CONTRACT_NUMBER_WAS_ADDED = "Номер договора был добавлен"
    CONTRACT_NUMBER_WAS_EDITED = "Номер договора был изменен"
    CONTRACT_NUMBER_REMAINED_THE_SAME = "Номер договора остался прежним"
    ...
    TICKET_ALREADY_OPENED = "Заявка уже в работе"
    TICKET_CLOSED = "Заявка закрыта"
    TICKET_ALREADY_CLOSED = "Заявка уже закрыта"
    DELETE_TICKET_NUMBER_X = "Удалить заявку №"
    ...
    TICKET_NOT_FOUND = "Заявка не найдена, возможно она была удалена"
    ...
    CANNOT_CLOSE_TICKET = "Нельзя закрыть заявку без контракта или с незаполненным или отсутствующим устройством. Устраните проблему и попробуйте снова"
    ...
    ADD_DEVICE_TO_TICKET = "Добавить устройство в заявку"
    CLOSE_TICKET = "Закрыть заявку"
    REOPEN_TICKET = "Вернуть заявку в работу"
    REOPEN_TICKET_X = "Вернуть в работу заявку"
    DELETE_TICKET = "Удалить заявку"
    LIMIT_OF_X_DEVICES_REACHED = (
        f"Максимальный лимит в {settings.devices_per_ticket} устройств был достигнут"
    )
    TICKET = "Заявка"
    CONTRACT = "Договор"
    TYPE = "Тип"
    ...
    INELIGIBLE_DEVICE_TYPE_ACTION = "Недопустимое действие для данного типа устройства"
    ...
    WRITEOFF = "Брак"
    ALL_WRITEOFFS = "Весь брак"
    WRITEOFF_DEVICES = "Бракованные устройства"
    ...
    FOREIGN_WRITEOFF = (
        "Бракованное устройство принадлежит другому пользователю, доступ ограничен"
    )
    WRITEOFF_DEVICE_DELETED = "Бракованное устройство удалено"
    ...
    DEVICE_TYPE_NOT_FOUND = "Данный тип устройства не найден"
    DEVICE_TYPE_HAS_NO_ACTIONS = "Данный тип устройства не имеет доступных действий"
    ...
    DEVICE_TYPE_IS_DISABLED = "Данный тип устройства в данный момент не используется"
    DEVICE_TYPE_IS_DISPOSABLE = "Данный тип устройства не нуждается в учете списания"
    DEVICE_TYPE_WAS_EDITED = "Тип устройства был изменен"
    DEVICE_TYPE_REMAINED_THE_SAME = "Тип устройства остался прежним"
    ...
    SERIAL_NUMBER_ADDED = "Серийный номер добавлен"
    ...
    RETURN_CHANGED_TO_INSTALL = "Возврат устройства изменен на его установку"
    DEVICE_ACTION_SET_TO = "Выбрано действие"
    DEVICE_ACTION_CHANGED = "Действие с устройством изменено"
    DEVICE_ACTION_REMAINED_THE_SAME = "Действие с устройством осталось прежним"
    ...
    CONFIRM_WRITEOFF_DEVICE_DELETION = "Подтвердите удаление бракованного устройства"
    CONFIRM_DELETE_WRITEOFF = "Да, удалить брак"
