...
from src.tg.models import UpdateTG, UserTG, MethodTG
...
class Dispatcher:
    ...
    async def process(self) -> list[MethodTG] | None:
        ...
        conversation_response_sequence: list[MethodTG] = await Conversation(
